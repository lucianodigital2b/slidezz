...
export default function LandingFooter({
    ...
    return (
        <footer
            ...
            style={{ borderTop: `1px solid ${INK}`, background: '#F9F6F4' }}
        >
            ...
            >
                <span
                    className="font-[Bebas_Neue] leading-[0.78] tracking-tight select-none"
                    style={{
                        fontSize: 'clamp(6rem, 23vw, 19rem)',
                        color: INK,
                        opacity: 0.06,
                        transform: 'translateY(16%)',
                        WebkitMaskImage: 'linear-gradient(to bottom, #000 32%, transparent 92%)',
                        maskImage: 'linear-gradient(to bottom, #000 32%, transparent 92%)',
                    }}
                >
                    Slidezz
                </span>
            ...
            <div className="relative z-10 mx-auto max-w-6xl px-6 pt-16 pb-8">
                ...
                <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="mt-1 font-[Bebas_Neue] text-2xl tracking-wide text-[#1A1A1A]">
                            Slidezz
                        </span>
                    </div>

                    <div className="flex items-center gap-3">
                        <span className="text-sm font-bold text-[#1A1A1A]">{socialLabel}</span>
                ...
                <div className="grid gap-10 md:grid-cols-2">
                    <div>
                        <h3 className="mb-4 text-base font-extrabold text-[#1A1A1A]">{reachOutTitle}</h3>
                        <a
                            href={contact.href}
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-sm font-medium text-[#888880]">{rights}</p>
