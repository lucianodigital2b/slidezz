...
const shellClasses =
    'group rounded-xl border border-input bg-white px-3.5 py-2 shadow-xs transition-[color,box-shadow] focus-within:border-[#FFE156] focus-within:ring-[3px] focus-within:ring-[#FFE156]/20';
...
export function GoogleButton({
    ...
    return (
        <a
            href={href}
            className="inline-flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-input bg-white text-sm font-medium text-foreground shadow-xs transition-colors hover:bg-muted/60 focus-visible:ring-[3px] focus-visible:ring-[#FFE156]/30 focus-visible:outline-none"
        >
