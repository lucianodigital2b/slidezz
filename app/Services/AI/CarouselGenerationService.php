...
- imagePrompt: image generation prompt for a background image that fits the slide content (max 60 words). If the topic is about a real person, company, brand, or organization: on slide 1 and 1–2 other key slides, write the prompt as a realistic photographic shot of that specific subject — e.g. "professional photo of Elon Musk speaking on stage, dramatic lighting, high resolution" or "Apple headquarters exterior, glass building, daytime, editorial photography". For remaining slides use conceptual or atmospheric imagery that fits the narrative. If the topic is abstract or fictional, always use conceptual imagery.
